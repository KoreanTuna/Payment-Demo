...
@override
String toString() {
  return 'CardScanEntity(cardNumber: $cardNumber, cardHolderName: $cardHolderName, expirationYear: $expirationYear, expirationMonth: $expirationMonth, cvc: $cvc)';
}
...
/// @nodoc
abstract mixin class $CardScanEntityCopyWith<$Res>  {
  factory $CardScanEntityCopyWith(CardScanEntity value, $Res Function(CardScanEntity) _then) = _$CardScanEntityCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CardScanEntityCopyWithImpl<$Res>
    implements $CardScanEntityCopyWith<$Res> {
  _$CardScanEntityCopyWithImpl(this._self, this._then);

  final CardScanEntity _self;
  final $Res Function(CardScanEntity) _then;
...
/// Adds pattern-matching-related methods to [CardScanEntity].
extension CardScanEntityPatterns on CardScanEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CardScanEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CardScanEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CardScanEntity value)  $default,){
final _that = this;
switch (_that) {
case _CardScanEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CardScanEntity value)?  $default,){
final _that = this;
switch (_that) {
case _CardScanEntity() when $default != null:
return $default(_that);case _:
...
class _CardScanEntity implements CardScanEntity {
  const _CardScanEntity({required this.cardNumber, required this.cardHolderName, required this.expirationYear, required this.expirationMonth, this.cvc});
  factory _CardScanEntity.fromJson(Map<String, dynamic> json) => _$CardScanEntityFromJson(json);
...
@pragma('vm:prefer-inline')
_$CardScanEntityCopyWith<_CardScanEntity> get copyWith => __$CardScanEntityCopyWithImpl<_CardScanEntity>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CardScanEntityToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CardScanEntity&&(identical(other.cardNumber, cardNumber) || other.cardNumber == cardNumber)&&(identical(other.cardHolderName, cardHolderName) || other.cardHolderName == cardHolderName)&&(identical(other.expirationYear, expirationYear) || other.expirationYear == expirationYear)&&(identical(other.expirationMonth, expirationMonth) || other.expirationMonth == expirationMonth)&&(identical(other.cvc, cvc) || other.cvc == cvc));
}
...
/// @nodoc
abstract mixin class _$CardScanEntityCopyWith<$Res> implements $CardScanEntityCopyWith<$Res> {
  factory _$CardScanEntityCopyWith(_CardScanEntity value, $Res Function(_CardScanEntity) _then) = __$CardScanEntityCopyWithImpl;
@override @useResult
$Res call({
 String cardNumber, String cardHolderName, int expirationYear, int expirationMonth, int? cvc
});
...
/// @nodoc
class __$CardScanEntityCopyWithImpl<$Res>
    implements _$CardScanEntityCopyWith<$Res> {
  __$CardScanEntityCopyWithImpl(this._self, this._then);

  final _CardScanEntity _self;
  final $Res Function(_CardScanEntity) _then;
